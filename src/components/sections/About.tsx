      ...
      <div className="grid justify-items-center gap-14 md:grid-cols-[3fr_2fr] md:justify-items-start">
        <div className="space-y-4 text-lg text-skin-primary xs:text-xl">
          <p>
            ...
            the internet. My interest in web development began after completing
            the Harvard CS50:{' '}
            <Link
          ...
          <p>
            ...
            JavaScript. Following that, I then learned React, Next.js, Tailwind
            CSS and TypeScript, which took my skills to the next level.
          </p>
          <p>
